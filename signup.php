...
<html>
<head>
<title>Sign up | Club Creative</title>	
...
<?php
	...
	if(empty($fname))
	{
		$err1="field cannot be empty";
		$errcount=1;	
	}
	
	if(empty($lname))
	{
		$err2="field cannot be empty";
		$errcount=1;	
	}
	...
	if(($fname!==" ")&&($errcount==0))
	{	
		$qry1="SELECT * FROM DPpl WHERE username='$usrname' AND password='$pass'";
		$res=$conn->query($qry1);
		$count=mysqli_num_rows($res);
		if($count>=1)
		{
			$err3="username already exists";
			$errcount=1;
		}	
		else
		{
			$qry2="INSERT INTO DPpl ( firstname, lastname, username, password) VALUES ( '".$fname."', '".$lname."', '".$usrname."', '".$pass."')";
...
<p class="cctext">Type up and be a part of the family! join Club Creative now, and unlock a whole new level of wholesomeness!</p>
</div>
<div class="elements" id="join2">
<p class="cctext">*no terms and conditions apply ;)</p>
</div>
<div class="elements" id="main_div">
	<div class="elements" id="forma" style="display: <?php echo $zoop1?>">
		<form action="<?php echo htmlspecialchars($_SERVER['PHP_SELF'])?>" method="post">
			<p class="field_description" id="n1">First Name<br></p>
			<input type="text" name="fname" class="field" size="43" maxlength="20" required><br><br><br>
			<p class="field_description" id="n2">Last Name<br></p>
			<input type="text" name="lname" class="field" size="43" maxlength="20" required><br><br><br>
			<p class="field_description" id="n3">User Name<br></p>
			<input type="text" name="usrname" class="field" size="43" maxlength="20" required><br><br><br>
			<p class="field_description" id="n4">Password<br></p>
			<input type="password" name="pass" class="field" size="43" maxlength="16" required><br><br><br>
			<input type="submit" value="submit " id="sub_but"><br>
		</form>
	</div>
	<p id="err1" class="err"><?php echo $err1;?></p>
	<p id="err2" class="err"><?php echo $err2;?></p>
	<p id="err3" class="err"><?php echo $err3;?></p> 
	<p id="err4" class="err"><?php echo $err4;?></p> 
	
	<h1 id="wlcm" style="display: <?php echo $zoop2?>">Welcome</h1>
	<p id="wcc" style="display: <?php echo $zoop2?>">to Club Creative!</p>
